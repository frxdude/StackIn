...
public interface QuestionService {
    ...
    ResponseEntity<Object> deleteAll(List<Long> deleteIdList) throws BusinessException;

    ResponseEntity<Object> deleteAllByUser(HttpServletRequest req) throws BusinessException;
